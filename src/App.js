...
function App({ fields, setFields }) {
  ...
  clickSound.volume = 0.2; // Adjust volume to 50%
  const openingSound = new Audio('/opening.wav');
  openingSound.volume =0.4; // Adjust volume to 50%
  ...
  const handleNewRecording = () => {
    openingSound.play(); // Play the opening sound when the new recording button is clicked
    setTranscript("");
    setFields({
      personalHistory: "",
      chiefComplaint: "",
